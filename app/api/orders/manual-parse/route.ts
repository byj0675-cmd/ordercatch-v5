...
export async function POST(req: Request) {
  try {
    ...
    const { text, storeId, enabledFields, storeFields, storeProducts } = body;
    ...
    const stream = await parseOrderStreamWithGemini(text, enabledFields, storeFields, storeProducts);
